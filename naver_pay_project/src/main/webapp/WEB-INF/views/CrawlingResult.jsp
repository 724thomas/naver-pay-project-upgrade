...
<head>
    ...
    <p>이름 : ${crawlingResult.get(0).userName} 연락처 : ${crawlingResult.get(0).userPhone}</p>
...
<c:forEach items="${crawlingResult}" var="result">
    ...
    <p>주문날짜: ${result.orderDate}   주문번호: ${result.orderId}</p>
    <p>제품명: ${result.productName}
    <p>제품수량: ${result.orderQuantity}   제품가격: ${result.productPrice}</p>
    <p>회사명: ${result.companyName}   회사대표번호: ${result.companyPhone}</p>
